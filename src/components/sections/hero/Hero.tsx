...
import {
    animateHeroEntrance,
    animateHeroSlideChange,
    animatePaginationBar,
...
export const Hero = () => {
    ...
    useEffect(() => {
        animateHeroSlideChange(descriptionRef.current);
        animatePaginationBar(paginationRef.current);
    }, [activeSlide]);
