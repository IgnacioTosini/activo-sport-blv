...
-- CreateEnum
CREATE TYPE "SurfaceType" AS ENUM ('FG', 'TF', 'AG', 'SG');
...
CREATE TABLE "Size" (
    "id" TEXT NOT NULL,
    "usSize" DOUBLE PRECISION NOT NULL,
    "eurSize" DOUBLE PRECISION NOT NULL,
    "cmSize" DOUBLE PRECISION NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "Size_usSize_eurSize_cmSize_key" ON "Size"("usSize", "eurSize", "cmSize");
